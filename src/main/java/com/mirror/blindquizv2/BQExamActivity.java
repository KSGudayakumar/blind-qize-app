...
public class BQExamActivity extends Activity implements OnClickListener {
    /**
    ...
    public void getQuestions(){
        ...
        String url ="https://d83arun.pythonanywhere.com/getQuestions";
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Toast.makeText(BQExamActivity.this,"User Data received successfully", Toast.LENGTH_SHORT).show();
                        System.out.println("Response :" + response);
                        try{
