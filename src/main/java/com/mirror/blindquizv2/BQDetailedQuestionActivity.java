...
public class BQDetailedQuestionActivity extends Activity implements OnClickListener {
    /**
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.setdetailedquestion);
    ...
    public void setQuestion(){
     ...
     /*   String mobile_no = mmobile.getText().toString();
      ...
      /*  optiona = medit_optiona.getText().toString();
        ...
        String url ="https://d83arun.pythonanywhere.com/addDetailedQuestion";
